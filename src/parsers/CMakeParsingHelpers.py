...
def isVarProvidedByCMake(name:str, projName :str)->bool:
    # TODO: handle templated names (contains <SOMETHING>)
    # TODO: Create this before, currently created everytime function is called...
    return True if name in [
     ...
     f"{projName}_BINARY_DIR",
     f"{projName}_DESCRIPTION",
     f"{projName}_HOMEPAGE_URL",
     f"{projName}_IS_TOP_LEVEL",
     f"{projName}_SOURCE_DIR",
     f"{projName}_VERSION",
     f"{projName}_VERSION_MAJOR",
     f"{projName}_VERSION_MINOR",
     f"{projName}_VERSION_PATCH",
     f"{projName}_VERSION_TWEAK",
     "PROJECT_BINARY_DIR",
     "PROJECT_DESCRIPTION",
     ...
     f"CMAKE_PROJECT_{projName}_INCLUDE",
     f"CMAKE_PROJECT_{projName}_INCLUDE_BEFORE",
